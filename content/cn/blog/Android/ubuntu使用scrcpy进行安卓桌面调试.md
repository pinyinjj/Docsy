...
case $1 in
    ...
    "screenshot")
        ...
        ;;
    *)
        echo "用法: $0 {list|restart|install|screenshot}"
        echo "  list      - 列出连接的设备"
        echo "  restart   - 重启ADB服务"
        echo "  install   - 安装APK文件"
        echo "  screenshot - 截取屏幕截图"
        ;;
esac
```
